          ...
          <div className="max-w-7xl mx-auto flex items-center justify-between gap-4 min-w-0">
            ...
            <Link to="/" className="flex items-center gap-3 group shrink-0" aria-label="JAAGA X - Home">
              <img
                src={jaagaxLogo}
                alt="JAAGA X"
                className="h-4 w-auto max-h-4 object-contain shrink-0 dark:brightness-0 dark:invert-[0.95]"
              />
            </Link>
          ...
          <div className="flex items-center justify-between gap-2 min-w-0">
            <Link to="/" className="flex items-center gap-2 shrink-0" aria-label="JAAGA X - Home">
              <img
                src={jaagaxLogo}
                alt="JAAGA X"
                className="h-8 w-auto max-h-8 object-contain shrink-0 dark:brightness-0 dark:invert-[0.95]"
              />
            </Link>

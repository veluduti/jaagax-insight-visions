                    ...
                    {availableAgents.map((agent) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <img src={agent.photo_url || '/placeholder.svg'} alt={agent.name || 'Agent'} className="w-12 h-12 rounded-full object-cover" onError={(e) => { (e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=100'; }} loading="lazy" decoding="async" />

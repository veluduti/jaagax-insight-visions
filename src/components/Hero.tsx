...
const Hero = ({ activeTab, onTabChange }: HeroProps) => {
  const statCards = [
    ...
    { icon: TrendingUp, value: "₹2.5L Cr", label: "Property Value" },
    { icon: Shield, value: "100%", label: "Trust Score" },
    { icon: Sparkles, value: "AI", label: "Powered Insights" },
  ];

  return (
    <div className="relative min-h-[85vh] flex items-center overflow-hidden pt-16 lg:pt-20">

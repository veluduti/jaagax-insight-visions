              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {form.amenityImages.map((img, i) => (
                  <div key={i} className="relative group">
                    <img src={img.url} alt={img.description} className="w-16 h-16 object-cover rounded-lg border" onError={(e) => (e.currentTarget.style.display = "none")} loading="lazy" decoding="async" />

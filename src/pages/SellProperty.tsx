...
import { validatePropertyImageName, validatePropertyRelevance } from "@/lib/validatePropertyFile";
  ...
  const handleQuickImage = async (files: FileList) => {
    ...
    try {
      if (isImage) {
        ...
        const validImage = await validatePropertyImageName(file.name);
        ...
        if (!validImage) {
          ...
          setMessages((m) => [
            ...m,
            {
              ...
              role: "ai",
              kind: "text",
              text: "This image doesn't appear related to a property listing. Please upload property photos, brochures, layouts, or floor plans.",
            },
          ]);

...
export const EDIT_FIELD_CONFIG: EditFieldSection[] = [
...

  {
    ...
    fields: [
      { id: "workspace_types", label: "Workspace types", type: "text", colSpan: 2 },
      { id: "workspace_plan", label: "Workspace plan", type: "text" },
      { id: "operating_as", label: "Operating as", type: "text" },
      { id: "community_type", label: "Community type", type: "text" },
      { id: "suitable_for", label: "Suitable for", type: "text", colSpan: 2 },
      { id: "access_24_7", label: "24/7 access", type: "text" },
      { id: "available_from", label: "Available from", type: "text" },
    ],
  },
];

        ...
        <section className="relative py-16 px-4 overflow-hidden bg-gradient-to-br from-background via-primary/5 to-background">
          <div className="container mx-auto max-w-7xl 3xl:max-w-[1680px]">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-bold">Stay Near Your Dream Property</h1>

              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Book comfortable accommodations near properties you want to visit. Exclusive discounts for JaagaX
                buyers.
              </p>

              {/* Partner with Us CTA */}
              <Button variant="premium" size="lg" onClick={() => navigate("/partners")} className="gap-2">
                ...
                <Card key={pkg.id} className="overflow-hidden">
                  <CardContent className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-primary font-semibold">Save up to {pkg.base_discount_percentage}%</span>
                      <Button
                        size="sm"
                        onClick={() => {
                          if (!user) {
                ...
                >
                  <div className="h-48 bg-gradient-to-br from-primary/20 to-accent/20 relative">
                    ...
                    {hotel.discount_percentage && (
                      <Badge className="absolute top-2 right-2 bg-green-600">{hotel.discount_percentage}% OFF</Badge>
                    )}
                  </div>
                  <CardContent className="p-4">

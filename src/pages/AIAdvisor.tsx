...
import { saveSearch } from "@/components/ai/SavedSearches";
    ...
    setMessages([
      {
        role: "assistant",
        content:
          '👋 Welcome to JaagaX AI Property Advisor! I\'m here to help you find your perfect home. Tell me what you\'re looking for, or try: "3BHK near Gachibowli under ₹1 crore" or "verified villas in Bangalore with high trust score"',
      },
    ]);
  }, []);
            ...
            <div className="border-t pt-4 space-y-3">
              ...
              {conversationContext && (
                <div className="flex gap-2">
                  <Input
                    ...
                    className="flex-1"
                  />
                  <Button onClick={handleSaveSearch} variant="outline" size="icon" title="Save search">
              ...
              <div className="flex gap-2">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Button onClick={handleSubmit} size="icon" disabled={isLoading || !query.trim()}>
              ...
              <p className="text-xs text-muted-foreground text-center">
                ...
                {conversationContext && "Ask follow-ups like 'show cheaper options' • "}Click mic for voice input
              </p>
            </div>
          </Card>
        </motion.div>

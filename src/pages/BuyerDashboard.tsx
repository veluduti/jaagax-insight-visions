      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Tabs defaultValue="recommended" className="space-y-6">
          ...
          <TabsContent value="visits">
            <Card>
              <CardHeader>
                <CardTitle>My Property Visits</CardTitle>
                <CardDescription>Track your scheduled and ongoing visits</CardDescription>
              </CardHeader>
              <CardContent>
                {visitBookings.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-muted-foreground mb-4">Book a property visit to get started</p>
                    <Button onClick={() => navigate("/map")}>Browse Properties</Button>
                  </div>
                ) : (
                  <>
                          ...
                          <div className="flex items-start justify-between mb-3">
                            ...
                            <Badge 
                              variant={
                                ...
                                visit.status === 'completed' ? 'secondary' : 
                                'outline'
                              }
                            >

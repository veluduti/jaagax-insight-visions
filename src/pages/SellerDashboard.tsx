...
import { Plus, Home, BarChart, LogOut } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-midnight via-midnight-light to-midnight">
      <nav className="glass-panel border-b border-glass px-6 py-4 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <h1 className="text-2xl font-bold text-cyan">JaagaX Seller</h1>
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="glass-panel border-glass p-6 hover:shadow-glow-cyan transition-all cursor-pointer">
            <Plus className="w-8 h-8 text-cyan mb-4" />
            <h3 className="text-xl font-semibold mb-2">Add Property</h3>
            <p className="text-muted-foreground text-sm">List a new property</p>
          </Card>

          <Card className="glass-panel border-glass p-6 hover:shadow-glow-cyan transition-all cursor-pointer">
            <Home className="w-8 h-8 text-cyan mb-4" />
            <h3 className="text-xl font-semibold mb-2">My Listings</h3>
            <p className="text-muted-foreground text-sm">View and manage properties</p>
          </Card>

          <Card className="glass-panel border-glass p-6 hover:shadow-glow-cyan transition-all cursor-pointer">
            <BarChart className="w-8 h-8 text-cyan mb-4" />
